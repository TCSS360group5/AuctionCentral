...
//		  answer.add(User.UserModel.EDITAUCTION);
//		  answer.add(User.UserModel.VIEWITEM);
//		  answer.add(User.UserModel.ADDITEM);
//		  break;
//	  case VIEWITEM:
//		  answer.add(User.UserModel.GOBACK);
//		  answer.add(User.UserModel.EDITITEM);
//		  break;
//	  case VIEWMAINMENU:
//		  if(canAddAuction()) {
//			  answer.add(User.UserModel.ADDAUCTION);			  
//		  } else {
//			  answer.add(User.UserModel.VIEWMYAUCTION);
//		  }
//	  break;
//		default:
...
//  	  {
//		  AuctionModel tempAuction = new AuctionModel(myNPOName, super.getUserName(), startTime, endTime);
...
//		  else
//		  {
//			  List<ItemModel> auctionItems = myAuction.getAuctionItems();
//			  AuctionModel newAuction = new AuctionModel(myNPOName, super.getUserName(), startTime, endTime, auctionItems);
...
//  }
//   
//  public int checkYear(Scanner user_input) 
//  {
//	  int year;
